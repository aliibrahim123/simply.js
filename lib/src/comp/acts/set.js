...
var setActs = {
	...
	'set:if' (comp, act) {
		comp.binder.addSet(act.prop, {type: 'if', el: act.el[0], prop: act.prop, condF: act.condF, fun: act.fun, args: act.args})
	},
	'set:if-else' (comp, act) {
		comp.binder.addSet(act.prop, {type: 'ifElse', el: act.el[0], prop: act.prop, conds: act.conds})
	},
	'set:for' (comp, act) {
