...
var handlers = {
	...
	attr (obj, val, comp) { //attr bind by template
		comp.view.attr(obj.el, obj.attr, $comp.temps.parseAttr.handle(obj.temp, comp, obj.el))
	},
	html (obj, val, comp) {
	...
	style (obj, val, comp) {
		obj.el.style.setProperty(obj.prop, obj.temp ? $comp.temps.parseAttr.handle(obj.temp, comp, obj.el) : val)
	},
	text (obj, val, comp) {
